...
public abstract class AbstractInterfaceConfig extends AbstractMethodConfig {
    ...
    protected List<URL> loadRegistries(boolean provider) {
        ...
        if (registries != null && !registries.isEmpty()) {
            ...
            for (RegistryConfig config : registries) {
                ...
                // 从启动参数 dubbo.registry.address 读取，若存在，最高优先级，进行覆
                ...
                if (address.length() > 0 && !RegistryConfig.NO_AVAILABLE.equalsIgnoreCase(address)) {
                    ...
                    // 将 ApplicationConfig 配置对象的属性，添加到参数集合
                    appendParameters(map, application);
                    // 将 RegistryConfig 配置对象的属性，添加到参数集合
    ...
    /**
     * 加载监控中心 com.alibaba.dubbo.common.URL 数组
     * @param registryURL registryURL 注册中心 URL
     * @return 监控中心 URL
     */
    protected URL loadMonitor(URL registryURL) {
        // 从 属性配置 中加载到 MonitorConfig 配置对象。
        if (monitor == null) {
        ...
        // 读取环境变量和 properties 配置到monitor配置对象
